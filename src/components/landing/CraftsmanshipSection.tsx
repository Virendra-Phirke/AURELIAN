  ...
  return (
    <section id="craftsmanship" ref={ref} className="relative py-28 px-6 sm:px-10 lg:px-16 overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-8 right-8 pointer-events-none hidden xl:block"
      >
        <ScrollOrb3D variant="polyhedron" size={100} speed={0.6} />
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-8 left-8 pointer-events-none hidden xl:block"
      >
        <ScrollOrb3D variant="polyhedron" size={90} speed={0.8} />
      </motion.div>
