    ...
    >
      <div className="bg-[#0a0a0a] border border-[#ffffff15] rounded-3xl p-8 sm:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative overflow-hidden">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-light text-white mb-3 italic tracking-tight">Reset Access</h1>
        ...
        {success ? (
          ...
          >
            ...
            <Link to="/login" className="inline-block text-[11px] uppercase tracking-widest text-[#C5A059] hover:text-[#d4b06a] transition-colors">
              Return to Login →
            </Link>
          </motion.div>
        ) : (
        ...
        {!success && (
          <p className="mt-8 text-center font-sans text-[11px] uppercase tracking-widest text-[#555]">
            Remember your password? <Link to="/login" className="text-[#C5A059] hover:text-[#d4b06a] ml-2 transition-colors">Log In</Link>
          </p>
        )}
      </div>
    </motion.div>
