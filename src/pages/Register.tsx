      ...
      <div className="bg-[#0a0a0a] border border-[#ffffff15] rounded-3xl p-8 sm:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.5)] relative overflow-hidden">
        ...
        <div className="mt-6 grid grid-cols-2 gap-4">
          <motion.button
            ...
            className="flex items-center justify-center gap-2 py-4 bg-[#111] border border-[#ffffff15] rounded-xl hover:border-[#ffffff30] transition-all text-white font-sans text-[10px] uppercase tracking-widest"
          >
