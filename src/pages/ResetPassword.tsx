    ...
    >
      <div className="bg-[var(--color-card-bg)] border border-[var(--color-border)] rounded-3xl p-8 sm:p-12 shadow-2xl relative overflow-hidden transition-colors">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-light text-[var(--color-primary-text)] mb-3 italic tracking-tight font-serif">New Password</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="••••••••"
              />
              {errors.confirmPassword && <span className="text-red-500 text-[10px] uppercase tracking-wider mt-2 block ml-1">{errors.confirmPassword.message}</span>}
            </div>
